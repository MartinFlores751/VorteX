...
bool LTexture::loadFromFile(SDL_Renderer* renderer, string path) {
	...
	if (loadedSurface == nullptr) {
		...
		SDL_SetColorKey(loadedSurface, 1, SDL_MapRGB(loadedSurface->format, 0xFF, 0xFF, 0xFF));
...
#ifdef _SDL_TTF_H
bool LTexture::loadFromRenderedText(SDL_Renderer* renderer, string textureText, SDL_Color textColor) {
	freeTexture();
